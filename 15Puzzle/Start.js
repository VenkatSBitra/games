class Start extends Phaser.Scene {
  ...
  create() {
    ...
    let game4 = new Phaser.Geom.Rectangle((config.width - 100 * window.devicePixelRatio) / 2 + 80 * window.devicePixelRatio, (config.height - 50 * window.devicePixelRatio) / 2 - 25 * window.devicePixelRatio, 100 * window.devicePixelRatio, 50 * window.devicePixelRatio)
    ...
    let game5 = new Phaser.Geom.Rectangle((config.width - 100 * window.devicePixelRatio) / 2 - 80 * window.devicePixelRatio, (config.height - 50 * window.devicePixelRatio) / 2 + 50 * window.devicePixelRatio, 100 * window.devicePixelRatio, 50 * window.devicePixelRatio)
    ...
    let game6 = new Phaser.Geom.Rectangle((config.width - 100 * window.devicePixelRatio) / 2 + 80 * window.devicePixelRatio, (config.height - 50 * window.devicePixelRatio) / 2 + 50 * window.devicePixelRatio, 100 * window.devicePixelRatio, 50 * window.devicePixelRatio)
    ...
    let rect = new Phaser.Geom.Rectangle((config.width - 200 * window.devicePixelRatio) / 2, (config.height - 50 * window.devicePixelRatio) / 2 + 150 * window.devicePixelRatio, 200 * window.devicePixelRatio, 50 * window.devicePixelRatio)
